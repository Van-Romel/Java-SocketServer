 ...
 */
public class FormCliente2 implements Runnable {
    ...
    public FormCliente2(String nome, int idade) {
        this.nome = nome;
        this.idade = idade;
    }
    ...
    public static void main(String[] args) {
        ...
        jButtonEnviar.addActionListener(FormCliente2::jBEnviarActionPerformed);
    ...
    private static void jBEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEnviarActionPerformed
        SwingUtilities.invokeLater(() -> {
            try {
                new Thread(new FormCliente2(caixaTextoNome.getText(), Integer.parseInt(caixaTextoIdade.getText()))).start();
                limparCampos();
